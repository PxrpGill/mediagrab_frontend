...
export const Search = observer(() => {
  ...
  return (
    <form
      onSubmit={
        query == 'Данный сервис не поддерживается.' || isGettedData
          ? resetQuery
          : handleSubmit
      }
    ...
    >
      <input
        ...
        name="query"
        className={
          isLoadingSearch || isGettedData ? styles.inputed : styles.input_link
        }
        placeholder="Вставьте ссылку на видео"
        disabled={
          isLoadingSearch || isGettedData || isErrorInput ? true : false
        }
      />
      <button
        type="submit"
      ...
      >
        {isLoadingSearch ? (
          ...
          >
            <path
              d="M12 22C10.6333 22 9.34167 21.7375 8.125 21.2125C6.90833 20.6875 5.84583 19.9708 4.9375 
            ...
            21.2125C14.6792 21.7375 13.3833 22 12 22Z"
              fill="#D5D4DA"
            />
          </svg>
          ...
          >
            <path
              d="M2.53366 19.3334L0.666992 17.4667L8.13366 10.0001L0.666992 
