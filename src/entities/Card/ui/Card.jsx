      ...
      <div className={styles.result_block}>
        ...
        <div className={styles.func}>
          <div className={styles.checkbox_block}>
            ...
            />
            <button className={styles.sponsor_block_open_modal}
