        ...
        >
          <g filter="url(#filter0_f_67_173)">
            ...
            <path
              ...
              144.343 355.364 137.2 407.839 141.246Z"
              fill="#4C2BC0"
            />
            <path
              fillRule="evenodd"
              ...
              147.955 172.113 136.897C199.137 127.993 226.995 128.049 255.414 129.465Z"
              fill="#2D9DE7"
            />
          </g>
          <defs>
            ...
            >
              ...
              <feGaussianBlur
                stdDeviation="50"
                result="effect1_foregroundBlur_67_173"
              />
            </filter>
          </defs>
        </svg>
